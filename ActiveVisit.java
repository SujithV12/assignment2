...
public class ActiveVisit 
{
	...
	address.click();
			...
			driver.findElement(By.xpath("//div[@class='col-11 col-lg-10']")).click();
			Thread.sleep(2000);
			...
			String given1 = givenname.getText();
			String firstname = "Bruce";
			
			if(given1.equals(firstname))
			{
				System.out.println("patient given name is Bruce");
			}
			Thread.sleep(2000);
